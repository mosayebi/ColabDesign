...
def main(argv):
    ...
    ag.add(["e1_context_max_tokens="], 48000, int, ["max tokens for the E1 MSA context. Final bias is the average of E1 logits over three progressively shorter contexts. default: 48000"])
